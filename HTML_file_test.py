...
# 1st: finds DOI, article title, year, and combines them into a string for the CSV file name
...
dftable.to_csv(create_folders() + f"/{table_title}.csv", header=True, encoding='utf-8-sig')
